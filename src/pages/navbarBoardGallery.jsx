        ...
        <nav className="bg-indigo-600">
            ...
            <div className="flex items-center justify-between h-16">
                ...
                <div className="hidden md:block">
                    ...
                    <a href="#" className="text-white hover:bg-indigo-500 hover:bg-opacity-75 px-3 py-2 rounded-md text-sm font-medium">Workspace Gallery</a>
                ...
                <div className="ml-4 flex items-center md:ml-6">
                    ...
                    <div className={dropDownClass} role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                        <a href="#" className={profileExpClass} role="menuitem" tabindex="-1" id="user-menu-item-0">{user.email}</a>

                        <a href="#" className={profileExpClass} role="menuitem" tabindex="-1" id="user-menu-item-1">Edit Profile</a>

                        <button onClick={signOut} className={profileExpClass} role="menuitem" tabindex="-1" id="user-menu-item-2">Sign Out</button>
                    </div>
                    </div>
                </div>
                </div>
