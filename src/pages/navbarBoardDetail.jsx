        ...
        <nav className="bg-indigo-600">
            ...
            <div className="flex items-center justify-between h-16">
                ...
                <div className="hidden md:block">
                    ...
                    <a href="#" className="text-white hover:bg-indigo-500 hover:bg-opacity-75 px-3 py-2 rounded-md text-sm font-medium">Board Gallery</a>
                ...
                <div className="ml-4 flex items-center md:ml-6">
                    ...
                    <div className={dropDownClass} role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                        ...
                        <button className={profileExpClass} role="menuitem" tabindex="-1" id="user-menu-item-2">Sign Out</button>
                    </div>
                    </div>
                </div>
                </div>
